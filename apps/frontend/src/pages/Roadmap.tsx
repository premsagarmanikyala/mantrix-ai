...
export default function Roadmap() {
  ...
  const generateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setGeneratedRoadmap({
        ...
        milestones: [
          { week: 1, title: 'Project Setup & Planning', description: 'Define requirements and set up development environment' },
          { week: 3, title: 'Core Development - Phase 1', description: 'Implement basic functionality and core features' },
          { week: 6, title: 'Core Development - Phase 2', description: 'Add advanced features and integrations' },
          { week: 9, title: 'Testing & Optimization', description: 'Comprehensive testing and performance optimization' },
          { week: 12, title: 'Deployment & Documentation', description: 'Deploy to production and complete documentation' },
        ],
        estimatedHours: timeframe === '1_month' ? 40 : timeframe === '3_months' ? 120 : timeframe === '6_months' ? 240 : 480
      })
    },
  })
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Roadmap Engine</h1>
          ...
          {!generatedRoadmap && !selectedProject && (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Select a project and configure your preferences to generate a roadmap.
              </p>
            </div>
          )}
          ...
          {selectedProject && !generatedRoadmap && (
            <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6">
              <div className="text-center">
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  Configure your preferences and click generate to create a learning roadmap.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-green-700 dark:text-green-300">
                      <p>Learning roadmap for "{selectedProject.title}" has been generated.</p>
                      <p className="mt-1">
                        Skill Level: {skillLevel} • Timeframe: {timeframe.replace('_', ' ')} • 
                        Estimated Hours: {generatedRoadmap.estimatedHours}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Learning Steps</p>
                </div>
              </div>
            </div>
          )}
