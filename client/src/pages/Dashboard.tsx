    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 text-white">
        ...
        <p className="text-blue-100">
          AI-Powered Learning Platform with Multi-Track Merge & Timeline
          Planning
        </p>
      </div>
                  ...
                  {progressData.branchProgress?.map((branch: any) => (
                    <div key={branch.branchId} className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span>
                          {branch.completed}/{branch.total} modules
                        </span>
                      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
              ...
              <span className="text-xl font-bold text-purple-600">
                {progressData?.completedHours || 0}h
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  • Generate personalized learning roadmaps with OpenAI GPT-4
                </li>
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Create your first AI-powered roadmap or explore the multi-track
              merge system.
            </p>
